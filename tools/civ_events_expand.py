...
CITY = {
    ...
    # 明末华北灾荒·扩展受灾区 + 江南缓冲（v0.50 影响范围 enriched）
    'xingxian': ('xingxian', '兴县',     111.13, 38.47, '山西，明末鼠疫发源地'),
    'luan':     ('luan',     '潞安',     113.13, 36.18, '山西，明末鼠疫重疫'),
    'linfen':   ('linfen',   '临汾',     111.50, 36.08, '山西平阳，明末旱蝗重灾'),
    'yulin':    ('yulin',    '榆林',     109.70, 38.30, '陕西，明末旱饥重灾'),
    'suide':    ('suide',    '绥德',     110.25, 37.50, '陕北，崇祯饥荒起'),
    'mizhi':    ('mizhi',    '米脂',     110.20, 37.48, '李自成故里，陕北重灾'),
    'shijiazhuang': ('shijiazhuang', '真定', 114.50, 38.04, '北直隶，旱疫重灾'),
    'hejian':   ('hejian',   '河间',     116.10, 38.43, '北直隶，明末大疫'),
    'guangping':('guangping','广平',     114.50, 36.76, '北直隶，旱蝗'),
    'daming':   ('daming',   '大名',     115.14, 36.28, '北直隶，明末鼠疫重灾'),
    'xuzhou':   ('xuzhou',   '徐州',     117.18, 34.26, '江苏，旱蝗泛及'),
    'fengyang': ('fengyang', '凤阳',     117.50, 32.90, '南直隶，蝗旱'),
    'shangqiu': ('shangqiu', '归德',     115.65, 34.41, '河南，旱蝗'),
    'runing':   ('runing',   '汝宁',     114.36, 33.00, '河南，旱蝗'),
    'weihui':   ('weihui',   '卫辉',     114.07, 35.43, '河南，旱蝗'),
    'huaiqing': ('huaiqing', '怀庆',     112.93, 35.08, '河南，旱蝗'),
    'zhangde':  ('zhangde',  '彰德',     114.35, 36.10, '河南，旱蝗'),
    'zezhou':   ('zezhou',   '泽州',     112.85, 35.49, '山西，旱蝗'),
    'pudong':   ('pudong',   '蒲州',     110.33, 34.83, '山西，黄河东岸'),
    'fenzhou':  ('fenzhou',  '汾州',     111.76, 37.27, '山西，旱疫'),
    'lanzhou':  ('lanzhou',  '兰州',     103.83, 36.06, '甘肃，旱饥重灾'),
    'yinchuan': ('yinchuan', '宁夏',     106.27, 38.47, '宁夏，旱饥'),
    'xiangyang':('xiangyang', '襄阳',     112.14, 32.00, '湖广，灾稍轻'),
    'changsha': ('changsha', '长沙',     112.94, 28.23, '湖广，蝗旱偏南'),
    'hangzhou': ('hangzhou', '杭州',     120.15, 30.27, '江南，未遭北灾'),
    'suzhou':   ('suzhou',   '苏州',     120.58, 31.30, '江南，未遭北灾'),
    'huaian':   ('huaian',   '淮安',     119.00, 33.50, '南直隶，泛及'),
    # 对外交流支点
...
# ══════════════ 天灾与生态 · 明末灾变（v0.49 影响范围热力模型）══════════════
{
 ...
 "parties_note": "灾情据张德二《中国三千年气象记录总集》及明末方志综合；全国人口由约 9987 万（崇祯初）减至 8848 万（灾后），减员逾千万，死亡数字各家估计差异大，此处取学界折中并标 _approx。",
 "places": [CITY['yanan'], CITY['suide'], CITY['mizhi'], CITY['changan'], CITY['yulin'], CITY['taiyuan'],
  CITY['linfen'], CITY['fenzhou'], CITY['kaofeng'], CITY['zhangde'], CITY['huaiqing'], CITY['weihui'],
  CITY['shangqiu'], CITY['runing'], CITY['beijing'], CITY['baoding'], CITY['shijiazhuang'], CITY['hejian'],
  CITY['daming'], CITY['guangping'], CITY['jinan'], CITY['xuzhou'], CITY['lanzhou'], CITY['yinchuan'],
  CITY['nanjing'], CITY['hangzhou'], CITY['suzhou'], CITY['xiangyang'], CITY['changsha']],
 "events": [
 ...
 "impact": {"years": [1628, 1644],
  "events": [{"year": 1628, "label": "陕北大饥，延安民食蓬草树皮"}, {"year": 1640, "label": "赤地千里，人相食"}, {"year": 1644, "label": "饥民从闯，明社遂倾"}],
  "impact": [
   {"place_id": "yanan", "start": 1628, "end": 1644, "level": 3, "deaths": 500000, "deaths_approx": True, "mortality": 0.5, "mortality_approx": True},
   {"place_id": "suide", "start": 1628, "end": 1644, "level": 3, "deaths": 200000, "deaths_approx": True, "mortality": 0.5, "mortality_approx": True},
   {"place_id": "mizhi", "start": 1628, "end": 1644, "level": 3, "deaths": 150000, "deaths_approx": True, "mortality": 0.5, "mortality_approx": True},
   {"place_id": "changan", "start": 1628, "end": 1644, "level": 2, "deaths": 600000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "yulin", "start": 1628, "end": 1644, "level": 3, "deaths": 200000, "deaths_approx": True, "mortality": 0.45, "mortality_approx": True},
   {"place_id": "taiyuan", "start": 1630, "end": 1644, "level": 2, "deaths": 500000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "linfen", "start": 1630, "end": 1644, "level": 2, "deaths": 300000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "fenzhou", "start": 1630, "end": 1644, "level": 2, "deaths": 200000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "kaofeng", "start": 1635, "end": 1644, "level": 3, "deaths": 1500000, "deaths_approx": True, "mortality": 0.4, "mortality_approx": True},
   {"place_id": "zhangde", "start": 1635, "end": 1644, "level": 3, "deaths": 400000, "deaths_approx": True, "mortality": 0.35, "mortality_approx": True},
   {"place_id": "huaiqing", "start": 1635, "end": 1644, "level": 3, "deaths": 300000, "deaths_approx": True, "mortality": 0.35, "mortality_approx": True},
   {"place_id": "weihui", "start": 1635, "end": 1644, "level": 3, "deaths": 300000, "deaths_approx": True, "mortality": 0.35, "mortality_approx": True},
   {"place_id": "shangqiu", "start": 1635, "end": 1644, "level": 2, "deaths": 300000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "runing", "start": 1635, "end": 1644, "level": 3, "deaths": 400000, "deaths_approx": True, "mortality": 0.35, "mortality_approx": True},
   {"place_id": "beijing", "start": 1638, "end": 1644, "level": 1, "deaths": 200000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "baoding", "start": 1638, "end": 1644, "level": 2, "deaths": 400000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "shijiazhuang", "start": 1638, "end": 1644, "level": 2, "deaths": 300000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "hejian", "start": 1638, "end": 1644, "level": 2, "deaths": 300000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "daming", "start": 1638, "end": 1644, "level": 2, "deaths": 300000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "guangping", "start": 1638, "end": 1644, "level": 2, "deaths": 250000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "jinan", "start": 1638, "end": 1644, "level": 2, "deaths": 500000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "xuzhou", "start": 1640, "end": 1644, "level": 2, "deaths": 300000, "deaths_approx": True, "mortality": 0.25, "mortality_approx": True},
   {"place_id": "lanzhou", "start": 1630, "end": 1644, "level": 2, "deaths": 200000, "deaths_approx": True, "mortality": 0.25, "mortality_approx": True},
   {"place_id": "yinchuan", "start": 1630, "end": 1644, "level": 2, "deaths": 150000, "deaths_approx": True, "mortality": 0.25, "mortality_approx": True}
  ]},
},
{
 ...
 "parties_note": "据气象史学者张德二研究综合，旱区范围与旱情顶峰（1640 前后）采其考订；旱灾直接死亡数难与饥、蝗、疫剥离，此处仅作粗略估算并标 _approx。",
 "places": [CITY['changan'], CITY['yulin'], CITY['taiyuan'], CITY['linfen'], CITY['fenzhou'], CITY['datong'],
  CITY['xingxian'], CITY['zezhou'], CITY['pudong'], CITY['kaofeng'], CITY['zhangde'], CITY['huaiqing'],
  CITY['weihui'], CITY['shangqiu'], CITY['runing'], CITY['beijing'], CITY['baoding'], CITY['shijiazhuang'],
  CITY['hejian'], CITY['daming'], CITY['guangping'], CITY['jinan'], CITY['xuzhou'], CITY['fengyang'],
  CITY['lanzhou'], CITY['yinchuan'], CITY['nanjing'], CITY['hangzhou'], CITY['suzhou'], CITY['xiangyang'], CITY['changsha']],
 "events": [
 ...
 "impact": {"years": [1637, 1643],
  ...
  "impact": [
   {"place_id": "changan", "start": 1637, "end": 1643, "level": 3, "deaths": 600000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "yulin", "start": 1637, "end": 1643, "level": 3, "deaths": 200000, "deaths_approx": True, "mortality": 0.4, "mortality_approx": True},
   {"place_id": "taiyuan", "start": 1637, "end": 1643, "level": 3, "deaths": 500000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "linfen", "start": 1637, "end": 1643, "level": 3, "deaths": 300000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "fenzhou", "start": 1637, "end": 1643, "level": 3, "deaths": 250000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "datong", "start": 1637, "end": 1643, "level": 3, "deaths": 250000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "xingxian", "start": 1637, "end": 1643, "level": 3, "deaths": 120000, "deaths_approx": True, "mortality": 0.35, "mortality_approx": True},
   {"place_id": "zezhou", "start": 1637, "end": 1643, "level": 2, "deaths": 200000, "deaths_approx": True, "mortality": 0.25, "mortality_approx": True},
   {"place_id": "pudong", "start": 1637, "end": 1643, "level": 2, "deaths": 150000, "deaths_approx": True, "mortality": 0.25, "mortality_approx": True},
   {"place_id": "kaofeng", "start": 1638, "end": 1639, "level": 2, "deaths": 300000, "deaths_approx": True, "mortality": 0.25, "mortality_approx": True},
   {"place_id": "kaofeng", "start": 1640, "end": 1643, "level": 3, "deaths": 1200000, "deaths_approx": True, "mortality": 0.4, "mortality_approx": True},
   {"place_id": "zhangde", "start": 1638, "end": 1643, "level": 3, "deaths": 400000, "deaths_approx": True, "mortality": 0.35, "mortality_approx": True},
   {"place_id": "huaiqing", "start": 1638, "end": 1643, "level": 3, "deaths": 300000, "deaths_approx": True, "mortality": 0.35, "mortality_approx": True},
   {"place_id": "weihui", "start": 1638, "end": 1643, "level": 3, "deaths": 300000, "deaths_approx": True, "mortality": 0.35, "mortality_approx": True},
   {"place_id": "shangqiu", "start": 1638, "end": 1643, "level": 3, "deaths": 300000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "runing", "start": 1638, "end": 1643, "level": 3, "deaths": 400000, "deaths_approx": True, "mortality": 0.35, "mortality_approx": True},
   {"place_id": "beijing", "start": 1638, "end": 1639, "level": 1, "deaths": 50000, "deaths_approx": True, "mortality": 0.1, "mortality_approx": True},
   {"place_id": "beijing", "start": 1640, "end": 1643, "level": 2, "deaths": 150000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "baoding", "start": 1638, "end": 1643, "level": 2, "deaths": 400000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "shijiazhuang", "start": 1638, "end": 1643, "level": 2, "deaths": 300000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "hejian", "start": 1638, "end": 1643, "level": 2, "deaths": 300000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "daming", "start": 1638, "end": 1643, "level": 2, "deaths": 300000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "guangping", "start": 1638, "end": 1643, "level": 2, "deaths": 250000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "jinan", "start": 1638, "end": 1639, "level": 1, "deaths": 150000, "deaths_approx": True, "mortality": 0.15, "mortality_approx": True},
   {"place_id": "jinan", "start": 1640, "end": 1643, "level": 2, "deaths": 400000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "xuzhou", "start": 1638, "end": 1643, "level": 2, "deaths": 300000, "deaths_approx": True, "mortality": 0.25, "mortality_approx": True},
   {"place_id": "fengyang", "start": 1640, "end": 1643, "level": 2, "deaths": 250000, "deaths_approx": True, "mortality": 0.25, "mortality_approx": True},
   {"place_id": "lanzhou", "start": 1637, "end": 1643, "level": 2, "deaths": 200000, "deaths_approx": True, "mortality": 0.25, "mortality_approx": True},
   {"place_id": "yinchuan", "start": 1637, "end": 1643, "level": 2, "deaths": 150000, "deaths_approx": True, "mortality": 0.25, "mortality_approx": True}
  ]},
},
{
 "id": "chongzhen_huangzai", "title": "崇祯蝗灾", "kind": "disaster", "region": "ecology",
 "region_name": RN['ecology'], "region_note": "1637—1644 连年特大蝗灾，1639—1640 极盛，蝗区遍及十省。",
 "dossier_label": "崇祯蝗灾", "subtitle": "1637—1644 · 华北连蝗", "primary_place": "kaofeng",
 "lead": "崇祯十年（1637）起华北连年蝗蝻，崇祯十二、十三年（1639—1640）达极盛，蝗区遍及甘肃、宁夏、山西、陕西、河北、河南、山东、江苏、安徽、湖北、湖南，「飞蝗蔽天、禾稼瞬息一空」。至崇祯十七年（1644）河南蝗极，竟有「飞蝗食人」之载。",
 "parties_note": "据张德二《中国三千年气象记录总集》及《中国蝗灾史》综合，蝗区范围与扩散年份采其考订；蝗灾致死多经饥馑，直接死亡数难剥离，此处仅作粗略估算并标 _approx。",
 "places": [CITY['kaofeng'], CITY['zhangde'], CITY['huaiqing'], CITY['weihui'], CITY['shangqiu'], CITY['runing'],
  CITY['taiyuan'], CITY['linfen'], CITY['fenzhou'], CITY['zezhou'], CITY['pudong'], CITY['changan'], CITY['yulin'],
  CITY['jinan'], CITY['xuzhou'], CITY['fengyang'], CITY['beijing'], CITY['baoding'], CITY['daming'], CITY['guangping'],
  CITY['xiangyang'], CITY['wuchang'], CITY['nanjing'], CITY['hangzhou'], CITY['suzhou'], CITY['changsha'], CITY['yinchuan'], CITY['lanzhou']],
 "events": [
  ("ev_hz_1637", "event:hz_1637", 1637, "崇祯十", "蝗起", "蝗灾", "陕东、晋南、豫开蝗蝻渐起，田禾受损。", "kaofeng"),
  ("ev_hz_1639", "event:hz_1639", 1639, "崇祯十二", "蝗极", "蝗灾", "飞蝗蔽天，蝗区遍及十省，禾稼瞬息一空。", "kaofeng"),
  ("ev_hz_1644", "event:hz_1644", 1644, "崇祯十七", "蝗食人", "蝗灾", "河南飞蝗食民间小儿，灾情骇人听闻。", "kaofeng"),
 ],
 "persons": [("zhangdeer2", "张德二", "气象史学者")],
 "impact": {"years": [1637, 1644],
  "events": [{"year": 1637, "label": "陕东、晋南、豫开蝗蝻渐起"}, {"year": 1639, "label": "蝗极：飞蝗蔽天，遍及十省"}, {"year": 1644, "label": "河南蝗极，竟有飞蝗食人"}],
  "impact": [
   {"place_id": "kaofeng", "start": 1637, "end": 1640, "level": 2, "deaths": 400000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "kaofeng", "start": 1641, "end": 1644, "level": 3, "deaths": 800000, "deaths_approx": True, "mortality": 0.35, "mortality_approx": True},
   {"place_id": "zhangde", "start": 1637, "end": 1644, "level": 2, "deaths": 300000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "huaiqing", "start": 1637, "end": 1644, "level": 2, "deaths": 250000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "weihui", "start": 1637, "end": 1644, "level": 2, "deaths": 250000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "shangqiu", "start": 1637, "end": 1644, "level": 2, "deaths": 250000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "runing", "start": 1637, "end": 1644, "level": 2, "deaths": 300000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "taiyuan", "start": 1637, "end": 1644, "level": 2, "deaths": 400000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "linfen", "start": 1637, "end": 1644, "level": 2, "deaths": 300000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "fenzhou", "start": 1637, "end": 1644, "level": 2, "deaths": 200000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "zezhou", "start": 1637, "end": 1644, "level": 2, "deaths": 200000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "pudong", "start": 1637, "end": 1644, "level": 2, "deaths": 150000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "changan", "start": 1637, "end": 1644, "level": 2, "deaths": 400000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "yulin", "start": 1637, "end": 1644, "level": 2, "deaths": 150000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "jinan", "start": 1637, "end": 1640, "level": 2, "deaths": 300000, "deaths_approx": True, "mortality": 0.15, "mortality_approx": True},
   {"place_id": "jinan", "start": 1641, "end": 1644, "level": 3, "deaths": 500000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "xuzhou", "start": 1637, "end": 1644, "level": 2, "deaths": 250000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "fengyang", "start": 1638, "end": 1644, "level": 2, "deaths": 250000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "beijing", "start": 1639, "end": 1644, "level": 2, "deaths": 200000, "deaths_approx": True, "mortality": 0.15, "mortality_approx": True},
   {"place_id": "baoding", "start": 1639, "end": 1644, "level": 2, "deaths": 250000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "daming", "start": 1640, "end": 1644, "level": 2, "deaths": 250000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "guangping", "start": 1640, "end": 1644, "level": 2, "deaths": 200000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "xiangyang", "start": 1641, "end": 1644, "level": 2, "deaths": 200000, "deaths_approx": True, "mortality": 0.15, "mortality_approx": True},
   {"place_id": "wuchang", "start": 1641, "end": 1644, "level": 2, "deaths": 200000, "deaths_approx": True, "mortality": 0.15, "mortality_approx": True}
  ]},
},
{
 ...
 "lead": "崇祯十四年（1641）起鼠疫自山西蔓延，崇祯十六年（1643）京师大疫，「死亡枕藉、十室九空」。至崇祯十七年（1644）李自成入京时，北京已为大疫笼罩，瘟疫与兵祸、饥荒相叠加，加速了明王朝的崩塌。曹树基据华北方志估计，明末两次鼠疫大流行中华北陕、晋、冀三省死亡至少千万人。",
 "parties_note": "鼠疫路径据曹树基《鼠疫：战争与和平》及明末清初笔记综合；北京死亡约 20 万、死亡率约三至四成采邱仲麟考订，其余省份死亡数为方志「人死大半」之折中估算，均标 _approx。",
 "places": [CITY['xingxian'], CITY['taiyuan'], CITY['luan'], CITY['linfen'], CITY['fenzhou'], CITY['datong'],
  CITY['yulin'], CITY['baoding'], CITY['daming'], CITY['shijiazhuang'], CITY['hejian'], CITY['beijing'],
  CITY['kaofeng'], CITY['zhangde'], CITY['huaiqing'], CITY['weihui'], CITY['shangqiu'], CITY['jinan'], CITY['xuzhou'],
  CITY['nanjing'], CITY['hangzhou'], CITY['suzhou'], CITY['xiangyang'], CITY['changsha'], CITY['changan'], CITY['yinchuan'], CITY['lanzhou']],
 "events": [
 ...
 "impact": {"years": [1641, 1644],
  ...
  "impact": [
   {"place_id": "xingxian", "start": 1641, "end": 1644, "level": 3, "deaths": 150000, "deaths_approx": True, "mortality": 0.5, "mortality_approx": True},
   {"place_id": "taiyuan", "start": 1641, "end": 1644, "level": 3, "deaths": 600000, "deaths_approx": True, "mortality": 0.35, "mortality_approx": True},
   {"place_id": "luan", "start": 1641, "end": 1644, "level": 3, "deaths": 250000, "deaths_approx": True, "mortality": 0.45, "mortality_approx": True},
   {"place_id": "linfen", "start": 1641, "end": 1644, "level": 3, "deaths": 350000, "deaths_approx": True, "mortality": 0.4, "mortality_approx": True},
   {"place_id": "fenzhou", "start": 1641, "end": 1644, "level": 2, "deaths": 200000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "datong", "start": 1641, "end": 1644, "level": 3, "deaths": 300000, "deaths_approx": True, "mortality": 0.4, "mortality_approx": True},
   {"place_id": "yulin", "start": 1641, "end": 1644, "level": 2, "deaths": 150000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "baoding", "start": 1642, "end": 1644, "level": 3, "deaths": 500000, "deaths_approx": True, "mortality": 0.5, "mortality_approx": True},
   {"place_id": "daming", "start": 1641, "end": 1644, "level": 3, "deaths": 500000, "deaths_approx": True, "mortality": 0.5, "mortality_approx": True},
   {"place_id": "shijiazhuang", "start": 1641, "end": 1644, "level": 3, "deaths": 400000, "deaths_approx": True, "mortality": 0.45, "mortality_approx": True},
   {"place_id": "hejian", "start": 1642, "end": 1644, "level": 3, "deaths": 400000, "deaths_approx": True, "mortality": 0.45, "mortality_approx": True},
   {"place_id": "beijing", "start": 1643, "end": 1644, "level": 3, "deaths": 200000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "kaofeng", "start": 1642, "end": 1644, "level": 2, "deaths": 300000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "zhangde", "start": 1642, "end": 1644, "level": 2, "deaths": 300000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "huaiqing", "start": 1642, "end": 1644, "level": 2, "deaths": 250000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "weihui", "start": 1642, "end": 1644, "level": 2, "deaths": 250000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "shangqiu", "start": 1642, "end": 1644, "level": 2, "deaths": 250000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "jinan", "start": 1642, "end": 1644, "level": 2, "deaths": 400000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "xuzhou", "start": 1642, "end": 1644, "level": 2, "deaths": 250000, "deaths_approx": True, "mortality": 0.25, "mortality_approx": True}
  ]},
},
{
 ...
 "parties_note": "据《汴围湿襟录》白愚、《豫变纪略》郑廉及《明史·庄烈帝纪》综合：围城军民约三十七万，存者不满两万，三十余万溺死饿毙；洪水「注涡水」，黄河由此改道由涡入淮，下游豫、皖、苏、鲁大涝。死亡与下游受灾数字为折中估算并标 _approx。",
 "places": [CITY['kaofeng'], CITY['zhengzhou'], CITY['shangqiu'], CITY['xuzhou'],
  CITY['fengyang'], CITY['huaian'], CITY['jinan']],
 "events": [
  ("ev_kf_1642a", "event:kf_1642a", 1642, "崇祯十五·六月", "双决黄河", "河决", "明军扒朱家寨、李自成扒马家口，黄河南北两处决口，相距三十里。", "kaofeng"),
  ("ev_kf_1642b", "event:kf_1642b", 1642, "九月十五", "开封城没", "河决", "秋汛两决合流，怒涛入北门，水深数丈，城如釜底，钟鼓二楼与周邸屋脊外尽没，三十余万军民溺毙。", "kaofeng"),
  ("ev_kf_1643", "event:kf_1643", 1643, "崇祯十六", "由涡入淮", "河决", "溃水注涡水，黄河改道由涡入淮，下游归德、徐州、凤阳、淮安、山东泛溢大涝。", "jinan"),
 ],
 "persons": [("lizicheng2", "李自成", "明末义军领袖")],
 "impact": {"years": [1642, 1644],
  "events": [{"year": 1642, "label": "明军与李自成军双决黄河（朱家寨·马家口）"}, {"year": 1642, "label": "秋汛合流，开封一夜没水"}, {"year": 1643, "label": "溃水由涡入淮，下游豫皖苏鲁大涝"}],
  "impact": [
   {"place_id": "kaofeng", "start": 1642, "end": 1644, "level": 3, "deaths": 340000, "deaths_approx": True, "mortality": 0.9, "mortality_approx": True},
   {"place_id": "zhengzhou", "start": 1642, "end": 1643, "level": 2, "deaths": 80000, "deaths_approx": True, "mortality": 0.4, "mortality_approx": True},
   {"place_id": "shangqiu", "start": 1643, "end": 1644, "level": 2, "deaths": 60000, "deaths_approx": True, "mortality": 0.3, "mortality_approx": True},
   {"place_id": "xuzhou", "start": 1643, "end": 1644, "level": 2, "deaths": 50000, "deaths_approx": True, "mortality": 0.25, "mortality_approx": True},
   {"place_id": "fengyang", "start": 1643, "end": 1644, "level": 2, "deaths": 40000, "deaths_approx": True, "mortality": 0.25, "mortality_approx": True},
   {"place_id": "huaian", "start": 1643, "end": 1644, "level": 2, "deaths": 40000, "deaths_approx": True, "mortality": 0.2, "mortality_approx": True},
   {"place_id": "jinan", "start": 1643, "end": 1644, "level": 1, "deaths": 20000, "deaths_approx": True, "mortality": 0.1, "mortality_approx": True}
  ]},
},
