...
// 权威数据源：data/scenes.json 注册的 15 个切片
window.SANDBOX_DATA = {
 "meta": {
  "project": "小菜狗的文明图景 / Vege-civilization",
  "slice": "multi-scene · 15 个切片",
  ...
  "novel_fandao": {
   ...
   "assertions": [
    ...
    },
    {
     ...
     "source": "novel_text",
     "layer": "gap",
     "claim": "其余八个快穿副本尚未抽取为结构化 world。",
     "value_text": "待抽取：深情渣帝王儿子 / 拜金绝色女儿 / 我的儿子是怪物 / 不负责的穿书女 / 同性恋骗婚儿子 / 爱情至上的女儿 / 不听话的喵儿子 / 胎穿女和魂穿女（共 8 个副本）",
     "lead": {
 ...
 "leads": {
  ...
  "leads": [
   ...
   },
   {
    ...
    "scene": "novel_fandao",
    "subject": "event:yu_mother_left",
    "title": "待抽取：深情渣帝王儿子 / 拜金绝色女儿 / 我的儿子是怪物 / 不负责的穿书女 / 同性恋骗婚儿子 / 爱情至上的女儿…",
