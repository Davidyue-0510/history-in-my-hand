...
window.SANDBOX_SLICES["pingyao"] = {
 ...
 "places": [
  ...
  },
  {
   ...
   "type": "商号旧址",
   "modern": "平遥古城内西大街",
   "note": "中国第一家票号旧址，位于平遥古城内西大街，约取古城中心近似坐标（CHGIS V6 治所坐标，WGS84：平遥县）",
   "geo_match": "chgis",
   "geo_note": "CHGIS V6 时间序列（Harvard Dataverse：府 DVN/WW1PD6、县 DVN/Q9VOF5；WGS84）：平遥县（CHGIS 平遥县治所（日昇昌票号所在平遥古城））",
   "elev": 784
  },
  {
   "id": "fen_he",
   ...
   "geo_match": "approx",
   "geo_note": "平遥西北邻汾河谷地，约取城西北近似坐标（112.05, 37.22）；CHGIS 未收录本要素，坐标据公开地理数据",
   "elev": 736
  },
  {
   "id": "liugen_he",
   ...
   "geo_match": "approx",
   "geo_note": "平遥古城南柳根河，约取城南沙河近似坐标（112.17, 37.19）；CHGIS 未收录本要素，坐标据公开地理数据",
   "elev": 809
  }
 ],
 "persons": [
