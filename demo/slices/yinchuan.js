 ...
 "places": [
  {
   ...
   "type": "古城/都城遗址",
   "modern": "宁夏银川市兴庆区",
   "note": "西夏都城兴庆府故地，今宁夏银川市城区，西夏政治、经济、文化中心。（近似坐标，待 CHGIS 精修）",
   "geo_match": "approx",
   "geo_note": "银川市中心近似坐标（106.27, 38.47），取自公开地理数据，待CHGIS精修",
   "elev": 1105
  },
  {
   "id": "xixia_tombs",
   ...
   "note": "西夏帝王陵寝群，位于贺兰山东麓，现存九座帝陵及二百余座陪葬墓，被誉为「东方金字塔」。（近似坐标，待 CHGIS 精修）",
   "geo_match": "approx",
   "geo_note": "西夏王陵景区近似坐标（105.99, 38.44），取自公开地理数据，待CHGIS精修",
   "elev": 1352
  },
  {
   "id": "helan_mountain",
   ...
   "note": "横亘于银川平原西侧，自古为中原王朝与北方游牧势力的分界线，西夏视为西陲屏障，山中有大量史前岩画。（近似坐标，待 CHGIS 精修）",
   "geo_match": "approx",
   "geo_note": "贺兰山银川段近似坐标（105.95, 38.50），取自公开地理数据，待CHGIS精修",
   "elev": 1635
  },
  {
   "id": "lingzhou",
   ...
   "type": "古城/军政枢纽",
   "modern": "宁夏灵武市",
   "note": "汉唐以来西北重镇，唐肃宗曾于此即位；北宋时期为宋夏争夺的战略要地，西夏立国后仍为东南门户。（近似坐标，待 CHGIS 精修）",
   "geo_match": "approx",
   "geo_note": "灵武市近似坐标（106.34, 38.10），取自公开地理数据，待CHGIS精修",
   "elev": 1150
  },
  {
   "id": "qingtongxia",
   ...
   "type": "水利/灌溉区",
   "modern": "宁夏青铜峡市",
   "note": "黄河中上游峡谷与灌区，秦渠、汉渠、唐徕渠等古渠流经，是银川平原「塞上江南」农业的根基。（近似坐标，待 CHGIS 精修）",
   "geo_match": "approx",
   "geo_note": "青铜峡市近似坐标（105.95, 38.02），取自公开地理数据，待CHGIS精修",
   "elev": 1182
  },
  {
   "id": "zhenbeibao",
   ...
   "type": "古堡/长城要塞",
   "modern": "宁夏银川市西夏区镇北堡镇",
   "note": "明代宁夏镇北路屯兵城堡，位于贺兰山口，控扼蒙古与河套南下通道，后成为著名影视基地。（近似坐标，待 CHGIS 精修）",
   "geo_match": "approx",
   "geo_note": "镇北堡 approximate coordinates（106.05, 38.60），取自公开地理数据，待CHGIS精修",
   "elev": 1404
  }
 ],
 "persons": [
