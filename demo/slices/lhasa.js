 ...
 "places": [
  {
   ...
   "type": "古城/都城遗址",
   "modern": "西藏自治区拉萨市",
   "note": "古称逻娑，吐蕃王朝都城；唐蕃古道终点、藏传佛教格鲁派根本道场所在，青藏高原政治与宗教中心。（近似坐标；CHGIS 仅收录历史政区治所，本要素不在其范围，坐标据公开地理数据）",
   "geo_match": "approx",
   "geo_note": "拉萨市中心近似坐标（91.14, 29.65），取自公开地理数据；CHGIS 未收录本要素，坐标据公开地理数据",
   "elev": 4093
  },
  {
   "id": "potala",
   ...
   "type": "宫殿/宗教圣地",
   "modern": "西藏自治区拉萨市城关区",
   "note": "初为松赞干布红山宫，五世达赖1645年重建扩建；宫堡、寺院、灵塔合一，藏传佛教与政教合一象征。（近似坐标；CHGIS 仅收录历史政区治所，本要素不在其范围，坐标据公开地理数据）",
   "geo_match": "approx",
   "geo_note": "布达拉宫近似坐标（91.117, 29.657），取自公开地理数据；CHGIS 未收录本要素，坐标据公开地理数据",
   "elev": 4103
  },
  {
   "id": "jokhang",
   ...
   "note": "约647年松赞干布时期始建，供奉释迦牟尼像；唐蕃会盟碑立于寺前，汉藏商旅与朝圣交汇中心。（近似坐标；CHGIS 仅收录历史政区治所，本要素不在其范围，坐标据公开地理数据）",
   "geo_match": "approx",
   "geo_note": "大昭寺近似坐标（91.132, 29.653），取自公开地理数据；CHGIS 未收录本要素，坐标据公开地理数据",
   "elev": 4099
  },
  {
   "id": "lhasa_river",
   ...
   "type": "河流/农业区",
   "modern": "西藏自治区拉萨市",
   "note": "雅鲁藏布江支流，纵贯拉萨河谷，灌溉便利，是拉萨城市、农业与人口发展的基础。（近似坐标；CHGIS 仅收录历史政区治所，本要素不在其范围，坐标据公开地理数据）",
   "geo_match": "approx",
   "geo_note": "拉萨河拉萨段近似坐标（91.13, 29.66），取自公开地理数据；CHGIS 未收录本要素，坐标据公开地理数据",
   "elev": 4137
  },
  {
   "id": "yarlung_tsangpo",
   ...
   "type": "河流/地理标志",
   "modern": "西藏自治区拉萨市以南",
   "note": "拉萨河谷段为青藏高原南北交通与唐蕃—青藏走廊枢纽，东接工布、西连后藏、北通青海。（近似坐标；CHGIS 仅收录历史政区治所，本要素不在其范围，坐标据公开地理数据）",
   "geo_match": "approx",
   "geo_note": "雅鲁藏布江拉萨段近似坐标（91.10, 29.40），取自公开地理数据；CHGIS 未收录本要素，坐标据公开地理数据",
   "elev": 4365
  },
  {
   "id": "norbulingka",
   ...
   "type": "园林/夏宫",
   "modern": "西藏自治区拉萨市城关区",
   "note": "清乾隆以来历代达赖夏宫，融藏式园林与汉地营造之法，是藏、汉、蒙古园林技术交融实例。（近似坐标；CHGIS 仅收录历史政区治所，本要素不在其范围，坐标据公开地理数据）",
   "geo_match": "approx",
   "geo_note": "罗布林卡近似坐标（91.09, 29.64），取自公开地理数据；CHGIS 未收录本要素，坐标据公开地理数据",
   "elev": 4033
  }
 ],
 "persons": [
