// 本文件由 tools/build.py 自动生成（切片 chongzhen_huangzai），请勿手工编辑。
// 加载后把本切片 bundle 挂到 window.SANDBOX_SLICES["chongzhen_huangzai"]。
(window.SANDBOX_SLICES = window.SANDBOX_SLICES || {});
window.SANDBOX_SLICES["chongzhen_huangzai"] = {
 "meta": {
  "kind": "disaster",
  "region": "ecology",
  "title": "崇祯蝗灾",
