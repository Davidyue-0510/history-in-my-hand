// 本文件由 tools/build.py 自动生成（切片 mingmo_shuyi），请勿手工编辑。
// 加载后把本切片 bundle 挂到 window.SANDBOX_SLICES["mingmo_shuyi"]。
(window.SANDBOX_SLICES = window.SANDBOX_SLICES || {});
window.SANDBOX_SLICES["mingmo_shuyi"] = {
 "meta": {
  "kind": "disaster",
  "region": "ecology",
  "title": "明末鼠疫",
  ...
  "strategic": {
   "political_cohesion": {
    ...
    "layer": "inference",
    "note": "明末鼠疫：朝堂凝聚力——朝野以疫为天谴、亡征，人心惶惶，士气瓦解。"
   },
   "material_logistics": {
    "from": [
     "tech",
    ...
    "layer": "inference",
    "note": "明末鼠疫：后勤物力——京营、守军染疫溃散，北京城防与勤王之师皆受重创。"
   },
 ...
 "assertions": [
  ...
  {
   "id": "AX_ev_sy_1644",
   "subject": "event:sy_1644",
   "predicate": "事件",
   "value_text": "李自成入京时京师大疫未息，明亡于疫、饥、兵交攻。",
   "source": "synthesis",
   "layer": "scholarship",
   "quote_status": "paraphrase_unverified",
   "confidence": 0.4,
