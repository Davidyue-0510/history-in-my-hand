...
window.SANDBOX_SLICES["qinghai_tuyuhun_llm"] = {
 ...
 "assertions": [
  ...
  {
   "id": "QIN_004",
   "subject": "event:ev_qinghai_tuyuhun_llm_03",
   "predicate": "损失",
   "value_text": "风雪冻毙过半",
   "time": {
    "era_text": "大业五年",
 ...
 "conflicts": [
  {
   "id": "cf:event:ev_qinghai_tuyuhun_llm_03|损失",
   "subject": "event:ev_qinghai_tuyuhun_llm_03",
   "predicate": "损失",
  ...
  {
   "id": "cf:event:ev_qinghai_tuyuhun_llm_02|影响",
   "subject": "event:ev_qinghai_tuyuhun_llm_02",
   "predicate": "影响",
   "kind": "record_vs_record",
   "count": 2,
