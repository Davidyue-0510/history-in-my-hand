 ...
 "rivers_override": [
  {
   "n": "大凌河",
   "approx": true,
   "note": "辽西主水系，源出建昌—朝阳间，东南流经锦州入渤海。大凌河堡因河得名。本线为公开地理数据近似。",
   "g": {
    "type": "LineString",
    "coordinates": [
     [
  ...
  },
  {
   "n": "小凌河",
   "approx": true,
   "note": "大凌河支流，流经锦州城北入渤海。本线为公开地理数据近似。",
   "g": {
    "type": "LineString",
    "coordinates": [
     [
